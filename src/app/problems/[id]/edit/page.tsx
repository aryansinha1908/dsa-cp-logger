  ...
  return (
    <div className="max-w-3xl mx-auto py-10 space-y-8">
      ...
      <div className="space-y-1">
        ...
        <p className="text-base text-muted-foreground">Update your notes, insights, or other details.</p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="px-6 py-4 border-t border-border bg-card flex justify-end gap-2">
            ...
            <Button type="submit" disabled={submitting} className="rounded-xl text-base px-6">
              {submitting ? <><Loader2 className="w-4 h-4 mr-1.5 animate-spin" />Saving…</> : "Save changes"}
            </Button>
          </div>
        </form>
      </div>
