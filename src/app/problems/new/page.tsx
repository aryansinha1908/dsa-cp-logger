    ...
    <div className="max-w-3xl mx-auto py-10 space-y-8">
      ...
      <div className="space-y-1">
        ...
        <p
          ...
          style={{ fontFamily: "var(--font-atkinson-mono), monospace" }}
        >
          Paste a LeetCode or Codeforces URL to auto-fill the details.
        </p>
      </div>
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="shrink-0 rounded-xl h-11 px-5 text-base"
                >
                  {loadingMeta ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="text-base rounded-xl h-11">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  readOnly
                  className="text-base rounded-xl h-11 bg-muted cursor-not-allowed text-muted-foreground"
                />
              </div>
              <div className="space-y-2">
